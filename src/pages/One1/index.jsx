    ...
    <>
      <div className="bg-gray_900 flex flex-col font-poppins items-center justify-end mx-auto w-full">
        <div className="flex flex-col items-end justify-end w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-11 items-start justify-between max-w-[1246px] mt-10 mx-auto md:px-5 w-full">
            <div className="flex md:h-[380px] sm:h-[596px] h-[788px] justify-end relative w-[32%] md:w-full">
                ...
                <div className="flex flex-col md:gap-10 gap-64 items-center justify-start mb-[15px] mt-[66px] w-full">
                  <div className="flex flex-col items-start justify-start w-[88%] md:w-full">
                    <Img
                      ...
                      alt="asset1shTwo"
                    />
                    <Text className="mt-8 text-white_A700" as="h6" variant="h6">
                      Get in touch
                    </Text>
                    <List
                      className="flex-col gap-6 grid items-center mt-[27px] w-full"
                      orientation="vertical"
                    >
                      <div className="bg-white_A700 border border-amber_700 border-solid flex flex-1 flex-row gap-[18px] items-center justify-center p-5 rounded-[10px] w-full">
                        ...
                        <CheckBox
                          className="font-normal leading-[normal] mr-[5px] my-[5px] sm:pr-5 text-[12.6px] text-gray_900 text-left"
                      ...
                      <div className="bg-white_A700 border border-amber_700 border-solid flex flex-1 flex-row gap-[18px] items-end justify-center p-[17px] rounded-[10px] w-full">
                        ...
                        <Text
                          className="mb-0.5 mr-11 mt-3.5 text-gray_900"
                          variant="body9"
                        >
                          We are company
                        </Text>
            ...
            <div className="h-[1761px] relative w-[65%] md:w-full">
              <div className="md:h-[582px] h-[792px] mb-[-210px] ml-0.5 w-[96%] md:w-full z-[1]">
                <Img
                ...
                <div className="absolute bg-gradient7  bottom-[2%] mb-[15px] p-0.5 rounded-bl-[100px] w-[97%] ">
                  <div className="absolute bg-gradient6  bg-gray_900 border-solid bottom-[0] flex flex-col gap-2.5 inset-x-[0] items-start justify-center mx-auto p-[13px] rounded-bl-[100px]">
                    <Text
              ...
              <div className="h-[1179px] md:h-[529px] mt-auto mx-auto w-full">
                <Img
                  src="images/img_ellipse2_529x106.png"
